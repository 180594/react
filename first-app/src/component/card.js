...
function Cartsxample() {
  return (
    <CardGroup>
      ...
      <Card>
        <Card.Img variant="top" src="https://chillandlit.tn/59137-home_default/survetement-enfant-jogging-veste.jpg" />
        <Card.Body>
          <Card.Title>jogging garcon</Card.Title>
          <Card.Text>
            prix=150d
          </Card.Text>
        </Card.Body>
